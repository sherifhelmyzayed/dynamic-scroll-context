              ...
              return (
                <>
                  <ModelLoader
                    ...
                    // group props
                    position={[0, 0, 2]}
                    startPosition={[0, 3, 0]} // starting animation position
                    endPosition={[0, 1, 0]} // ending animation position
                    url='/chair.glb' // pass url of the glb
                    min={0.5} // min offset 0-1
                    max={1} // max offset 0-1
                    enableTranslationAnimation={true} // default is true
                    enableOpacityAnimation={false} // default is false
                  />
                  <ModelLoader
                    position={[0, 0, 4]}
                    endPosition={[0, 1, 4]}
                  ...
                  <TextureLoader
                    ...
                    startPosition={[0, 1, 5]}
                    enableTranslationAnimation={true} // default is true
                    enableOpacityAnimation={true} // default is false
                  />
                </>
              );
            }}
